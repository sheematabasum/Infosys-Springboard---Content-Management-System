...
const Navbar = () => {
  return (
    ...
    <Link href="/"className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
        <img width={35} src="/shop.svg" alt=""></img>
      ...
      <button className="my-2 text-white bg-pink-800 border-0 py-2 px-4 focus:outline-none hover:bg-pink-800 rounded text-sm">Login</button>
    </div>
  </header></div>
  )
}
